        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreditAmount = table.Column<decimal>(type: "decimal(16,4)", nullable: true),
                    DebitAmount = table.Column<decimal>(type: "decimal(16,4)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountTransactions", x => x.ObjectID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ObjectID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Balance = table.Column<decimal>(type: "decimal(16,4)", nullable: true, defaultValue: 0m),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountDetails", x => x.ObjectID);
                    table.ForeignKey(
